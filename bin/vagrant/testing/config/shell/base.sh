...
#modules
apt-get install -y php7.0-cli php7.0-mysql php7.0-gd php7.0-curl php7.0-ldap php-soap php-pear php7.0-imap
...
cp /vagrant_config/files/php-fpm/vagrant.conf /etc/php/7.0/fpm/pool.d/vagrant.conf
